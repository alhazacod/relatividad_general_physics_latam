...
# This file was *autogenerated* from the file punto_d.sage
...
X = M.chart(r"v r:(0,+oo) th:(0,pi):\theta ph:(0,2*pi):\varphi:periodic", names=('v', 'r', 'th', 'ph',)); (v, r, th, ph,) = X._first_ngens(4)
...
g[_sage_const_0 ,_sage_const_1 ] = _sage_const_2 
